...
const Home = () => (
  <section className="prose p-4 lg:p-0">
    ...
    <p>
      I&apos;m passionate about web development and focus on creating rich, fast
      and accessible applications.
    </p>
    <div className="flex items-center gap-2">
      <Link href="https://github.com/mrodrigues95">
        <svg
          className="h-5 w-5"
          aria-hidden="true"
          viewBox="0 0 24 24"
      ...
      <Link href="https://www.linkedin.com/in/mrodrgs/">
        <svg
          className="h-5 w-5"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
